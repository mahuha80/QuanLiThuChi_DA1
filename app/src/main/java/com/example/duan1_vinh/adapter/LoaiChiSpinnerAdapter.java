...
public class LoaiChiSpinnerAdapter implements SpinnerAdapter {
    private Context context;
    private List<LoaiChi> list;

    public LoaiChiSpinnerAdapter(Context context, List<LoaiChi> list) {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        tv.setText(list.get(position).getTenloaichi());
        return view;
    }
